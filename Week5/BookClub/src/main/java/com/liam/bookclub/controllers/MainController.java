package com.liam.bookclub.controllers;
...
import com.liam.bookclub.models.LoginUser;
import com.liam.bookclub.models.User;
import com.liam.bookclub.services.BookService;
import com.liam.bookclub.services.UserService;
...
public class MainController {
	...
	public String updateSerf(@PathVariable("id") Long id, @Valid @ModelAttribute("book") Book serf, BindingResult result, @RequestParam("owner") User user, Model model, HttpSession session) {
		if (result.hasErrors()) {
